...
(let [json-str-new-agent-1 "{
  ...
  (facts "kworded-content"
         (fact "Receives a 'agent' flag and a 'json-formatted-agent'
         ...
         (fact "Receives a 'job' flag and a 'json-formatted-agent'
         and returns a 'clj-formatted-agent` with namespaced kwds"
         ...
         (fact "Receives a 'job-request' flag and a 'json-formatted-agent'
         and returns a 'clj-formatted-agent` with namespaced kwds"
